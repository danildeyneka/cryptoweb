...
export const Cryptocurrencies: FC<{ simplified?: boolean }> = ({simplified}) => {
    ...
    const [cryptos, setCryptos] = useState<coinT[] | undefined>(cryptoData?.data?.coins)
    ...
    const mappedCryptos = cryptos?.map((i) => (<Col lg={ 6 } key={ i.uuid }>
    ...
    return <>
        <div className="text-base my-4 w-64 mx-auto">
